...
var ADE7878REG = map[string][]byte{
	...
	"VNOM":      []byte{0xE5, 0x20},
	"IARMS_LRIP":	[]byte{0xE5, 0x30},
	"VARMS_LRIP":	[]byte{0xE5, 0x31},
	"IBRMS_LRIP":	[]byte{0xE5, 0x32},
	"VBRMS_LRIP":	[]byte{0xE5, 0x33},
	"ICRMS_LRIP":	[]byte{0xE5, 0x34},
	"VCRMS_LRIP":	[]byte{0xE5, 0x35},
	"INRMS_LRIP":	[]byte{0xE5, 0x36},
